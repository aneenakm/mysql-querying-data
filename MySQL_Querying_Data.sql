...
ALTER TABLE Employees ADD Email VARCHAR(50); -- Email Added
ALTER TABLE Employees MODIFY Designation VARCHAR(200); -- Designation changed 
ALTER TABLE Employees DROP Age; -- drop age
SELECT * FROM Employees;
SELECT * FROM Departments;
SELECT * FROM Location;
ALTER TABLE Employees RENAME COLUMN Hire_Date TO Date_of_Joining ; -- Renamed hiredate
...
Select Employee_name , Age AS Employee_Age , Salary AS Employee_Salary from Employees;

-- q3. Where Clause & Operators:Retrieve employees with a salary greater than ₹50000 and hired before 2016-01-01
Select * from Employees 
...
Select * from Employees 
	where Designation IS NULL; -- to find null designation
Update Employees SET Designation = "Data Scientist" 
	where employee_id = 5004; -- updating to Data scientist
SELECT * from Employees 
	WHERE Designation = 'Data Scientist'; -- checking whether updated
...
Select * from Employees where Hire_date BETWEEN '2018-01-01' and '2018-12-30' ORDER BY Hire_date ASC LIMIT 5;
